...
\textbf{Target: ConvNeXt (Ch 9).} Same Ch 2 subset as
EfficientNet. Ch 9 introduces LayerNorm and GELU as new primitives
but their VJPs are self-contained --- the proofs reuse BN's three-term
template (Ch 5) for LayerNorm and \(\fderiv\) directly for GELU,
neither of which reaches back into the tensor-calculus chapter.
...
This section walks through those hundred lines.
...
is $\sim$102M of the 138M for VGG-16. This is the dense-head bloat
that GAP + single-FC heads (Network-in-Network 2013, ResNet 2015)
eventually fixed.
