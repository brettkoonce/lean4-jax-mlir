...
\subsection*{YOLOv1 (\texttt{Bestiary/YOLO.lean})}
Zero new primitives --- just \texttt{conv2d} + \texttt{maxPool} +
\texttt{flatten} + \texttt{dense}. The YOLO-ness lives in the loss
function (grid assignment, IoU weighting) and the output reshape, both
training-time concerns outside \texttt{NetSpec}. Variants: full (271M,
paper-exact), fast, tiny.
